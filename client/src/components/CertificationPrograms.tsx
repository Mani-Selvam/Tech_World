                                        ...
                                        <div className="relative z-10">
                                            <div className="mb-8 pb-8 border-b border-white/10">
                                                ...
                                                <p className="text-emerald-300 text-sm font-semibold mt-3">
                                                    💰 Save {Math.round(((parseInt(selected.originalPrice.replace(/[^0-9]/g, '')) - parseInt(selected.price.replace(/[^0-9]/g, ''))) / parseInt(selected.originalPrice.replace(/[^0-9]/g, ''))) * 100)}% today
                                                </p>
                                            </div>
