      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <div className="flex justify-center items-center gap-3 sm:gap-4 mb-8 sm:mb-12">
            {/* Bitcoin */}
            <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full bg-gradient-to-b from-yellow-300 to-yellow-500 flex items-center justify-center shadow-2xl transform transition-all duration-300 hover:scale-110 hover:rotate-12 animate-bounce" style={{animationDelay: '0s'}}>
              <span className="text-yellow-800 font-bold text-lg sm:text-xl lg:text-2xl">₿</span>
            </div>
            
            {/* Ethereum */}
            <div className="w-14 h-14 sm:w-[72px] sm:h-[72px] lg:w-24 lg:h-24 rounded-full bg-gradient-to-b from-gray-300 to-gray-500 flex items-center justify-center shadow-2xl transform scale-110 transition-all duration-300 hover:scale-125 hover:rotate-12 animate-bounce" style={{animationDelay: '0.3s'}}>
            ...
            {/* Litecoin */}
            <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-full bg-gradient-to-b from-gray-200 to-gray-400 flex items-center justify-center shadow-2xl transform transition-all duration-300 hover:scale-110 hover:rotate-12 animate-bounce" style={{animationDelay: '0.6s'}}>
          ...
          <div className="absolute top-12 left-1/4 hidden md:block animate-pulse">
            <svg width="20" height="20" viewBox="0 0 24 24" className="text-yellow-400 drop-shadow-lg">
              <path fill="currentColor" d="M7 14l5-5 5 5z"/>
            </svg>
          </div>
          <div className="absolute top-20 right-1/4 hidden md:block animate-pulse" style={{animationDelay: '0.3s'}}>
            <svg width="18" height="18" viewBox="0 0 24 24" className="text-yellow-300 drop-shadow-lg">
              <path fill="currentColor" d="M7 14l5-5 5 5z"/>
            </svg>
          </div>
          <div className="absolute bottom-32 left-1/3 hidden lg:block animate-pulse" style={{animationDelay: '0.7s'}}>
            <svg width="16" height="16" viewBox="0 0 24 24" className="text-yellow-400 drop-shadow-lg">
              <path fill="currentColor" d="M7 14l5-5 5 5z"/>
            </svg>
          </div>
        </div>
          ...
          {strategies.map((strategy, index) => (
            ...
            >
              ...
              <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                <svg width="14" height="14" viewBox="0 0 24 24" className="text-yellow-400 sm:w-4 sm:h-4 animate-pulse drop-shadow-lg">
                  <path fill="currentColor" d="M7 14l5-5 5 5z"/>
                </svg>
              </div>
