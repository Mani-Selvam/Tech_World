...
export default function Academy() {
    ...
    const Label = ({ text }: { text: string }) => (
        <div
            className="absolute bottom-1 left-1 px-2 py-0.5 rounded-md 
        text-[10px] sm:text-xs font-medium 
        bg-gradient-to-r from-purple-600/70 to-blue-600/70 
        text-white shadow-[0_0_8px_rgba(139,92,246,0.8)] 
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <p className="text-base sm:text-lg text-gray-300 max-w-lg leading-relaxed font-medium">
                                    Learn from industry experts with live
                                    projects, real-world applications, and
                                    become a certified blockchain developer in
                                    just 3 months
                                </p>
                            </motion.div>
                        ...
                        <motion.div
                            ...
                            <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg aspect-square">
                                {/* Outer Glow */}
                                <motion.div
                                    className="absolute inset-0 rounded-3xl bg-gradient-to-r from-purple-600/30 to-cyan-600/30 blur-2xl"
                                    animate={{ rotate: 360 }}
                                    transition={{
                                        duration: 20,
                                        repeat: Infinity,
